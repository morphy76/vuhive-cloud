...
describe('RunSummaryDashboard', () => {
  ...
  describe('KPI Metric Cards', () => {
    ...
    it('displays Latency Percentiles summary badges (p50, p90, p95, p99)', async () => {
      ...
      expect(screen.getAllByText(/p50/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/25.4\s*ms/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/p90/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/42.1\s*ms/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/p95/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/58.7\s*ms/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/p99/i)[0]).toBeInTheDocument()
      expect(screen.getAllByText(/89.2\s*ms/i)[0]).toBeInTheDocument()
    })
  })
