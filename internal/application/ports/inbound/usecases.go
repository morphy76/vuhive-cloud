...
type SchedulesUseCase interface {
	...
	UpdateSchedule(ctx context.Context, id string, cronExpr *string, isActive *bool) (*model.Schedule, error)
...
type BuildsUseCase interface {
	...
	BuildArtifactWithOptions(ctx context.Context, suiteID, artifactID string, opts BuildOptions) (*model.Artifact, error)
