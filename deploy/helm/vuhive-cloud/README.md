...
| `auth.issuerUrl` | Keycloak realm OIDC issuer URL (e.g. `http://<keycloak-svc>:8080/auth/realms/vuhive` or `https://auth.example.com/auth/realms/vuhive`) | `""` |
